...
class ExpenseTest {
    ...
    @Test
    void getOwner() {
        Expense e = new Expense(1,5.5,"Food", Currency.USD,"EREZ","2021-12-12", Frequency.YEARLY);
        assertEquals(1,e.getOwner());
    }
    ...
    void testToString() {
        Expense e = new Expense(1,5.5,"Food", Currency.USD,"EREZ","2021-12-12", Frequency.YEARLY);
        String expected="Expense{ownerID=1, cost=5.5, category=Food, currency=USD, description='EREZ', creationDate=2021-02-13, dueDate=2021-12-12, type=YEARLY}";
